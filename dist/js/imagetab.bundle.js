...
Object(_helpers_Utils__WEBPACK_IMPORTED_MODULE_1__[/* updateOptions */ "d"])(options); // キーを押したとき

document.addEventListener('keydown', e => {
  // if 設定が有効なら
  // かつ 押されたキーがC-s の状態なら
  // かつ 開いているURLが画像URLの定形なら(pbs.twimg.comを使うものは他にも存在するので)
  if (options[_helpers_Constants__WEBPACK_IMPORTED_MODULE_0__[/* STRIP_IMAGE_SUFFIX */ "l"]] !== 'isfalse' && e.key === 's' && (e.ctrlKey || e.metaKey)) {
